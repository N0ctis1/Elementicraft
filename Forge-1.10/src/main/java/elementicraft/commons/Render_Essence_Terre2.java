...
public class Render_Essence_Terre2 extends Render<EntityXPOrb>
{
    private static final ResourceLocation EXPERIENCE_ORB_TEXTURES = new ResourceLocation("elementicraft","textures/items/Terre.png");

    public Render_Essence_Terre2(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(Essence_Terre2 entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
