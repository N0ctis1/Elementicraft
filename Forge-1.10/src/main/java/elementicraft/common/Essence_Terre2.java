...
public class Essence_Terre2 extends EntityXPOrb
{
    ...
    public Essence_Terre2(World worldIn, double x, double y, double z, int expValue)
    {
        super(worldIn);
    ...
    public Essence_Terre2(World worldIn)
    {
        super(worldIn);
